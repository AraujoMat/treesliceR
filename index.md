...
[![treesliceR
website](reference/figures/treesliceR_logo.png)](https://araujomat.github.io/treesliceR/)
...
![Figure 1: This figure provides illustrated examples of the functions
for slicing phylogenies available within treesliceR. The red dashed
lines indicate hypothetical temporal thresholds input by the
user.](reference/figures/Framework1.png)
...
details, see treesliceR CRAN).](reference/figures/Framework2.png)
