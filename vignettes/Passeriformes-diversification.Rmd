...
Now, we need to split the phylogeny into two distinct portions: one representing ancient lineages and another representing those originating from recent cladogenesis events. To do this, we categorically defined ancient species as those with tips ages beyond the 75º quantile, while more derived were categorized as those located within the 25º quantile. 
...
AU_grid$SR_rec_anc <- rowMeans(mat_rec_endemics)
