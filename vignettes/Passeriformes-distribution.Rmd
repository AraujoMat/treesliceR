...
This article aims to map the species richness distributions of older and young lineages of Australian passerines. Using the `treesliceR` tools, we'll compare the spatial distribution between these lineages and explore emergent biodiversity patterns in space.
